...
import dealBanner from './assets/GOM_DON_SIEU_TIEC.webp'
...
const campaignTarget = (item, now = new Date()) => {
  ...
  return { schedule, state, date: state.target || schedule?.eventStart || new Date(8640000000000000) }
}
